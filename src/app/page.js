...
let hobbies = [
    ...
    ‘Traveling’,
      ...
      <div className="absolute inset-x-0 bottom-0 h-[8rem] sm:h-[12.5rem] sm:opacity-60 w-full -z-10 bg-repeat-x bg-[length:10px_240px] bg-[url('/images/bg-gradient.svg')] pointer-events-none"></div>
      <div
        id="crt"
        className="fixed inset-0 z-40 w-full h-screen pointer-events-none mix-blend-overlay crt-line opacity-30"
      ></div>
    </main>
  );
}
